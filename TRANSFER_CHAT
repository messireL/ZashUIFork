...
- обнаруженные дополнительные VPN/туннели выводятся на диаграмме отдельными сериями по интерфейсам, а активные хосты по живым соединениям Mihomo показываются отдельным списком под диаграммой
