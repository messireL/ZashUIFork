...
const ru: LANG_MESSAGE = {
  ...
  limitsEnforcementNote: 'Важно: на этой версии ядра UI может только отключать активные соединения через API. Это приближает блокировку, но не является firewall-ограничением.',
